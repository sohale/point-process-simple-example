...
### Screenshot
Statisticall modelling of Spike Trains as Point Processes. Note Λ(t) = ∫ λ(t) dt is the times-rescaling function. x[k] is the input (state). In physiologicla terms, the input signal is the EPSP/IPSP.
