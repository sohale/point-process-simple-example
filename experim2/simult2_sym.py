...
def generates_time_points(λ_arr, ΔT, tΞ):
    # tΞ
...
# Λ_quantiles
Λ_atϟ, spike_times = \
    generates_time_points(λ_arr_A[neuron_id], simargs1.Delta, tΞ)
...
simulation_result = \
    (tΞ, x_ΞΞ, xlogpr_ΞΞ, λ_arr_A, ϟ_times_ξ, Λ_at_spikes_ξ, fire_probability_arr_A, Nc_arr_A, I_arr_A2)
